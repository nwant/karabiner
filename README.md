...
A fork of [mxstbr/karbiner](https://github.com/mxstbr/karabiner/pull/4).
...
1. Create a symlink with `ln -s ~/github/karabiner ~/.config` (where `~/github/karabiner` is your local path to where you cloned the repository)
